        ...
        <div class="row">
                ...
                <div class="card card-profile shadow">
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img alt="Image placeholder" class="rounded-circle" src="{{ asset('foto/'. auth()->user()->foto) }}">
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            <h3>
                                {{ auth()->user()->nombre }}<span class="font-weight-light">, {{ auth()->user()->nickname }}</span>
                            </h3>
            ...
            <div class="col-xl-8 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('user.update',auth()->id() ) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Nombre') }}" value="{{ old('name', auth()->user()->nombre) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('foto') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="file" name="foto" id="input-foto" class="form-control form-control-alternative{{ $errors->has('foto') ? ' is-invalid' : '' }}" placeholder="{{ __('Foto') }}" value="{{ old('foto', auth()->user()->foto) }}">
